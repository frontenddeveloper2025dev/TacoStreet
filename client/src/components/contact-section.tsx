      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-6 border-2 border-taco-red text-center shadow-lg">
            ...
            <p className="text-gray-800 mb-2">Calle Revolución 123</p>
            <p className="text-gray-800 mb-2">Colonia Centro</p>
          ...
          <div className="bg-white rounded-2xl p-6 border-2 border-taco-yellow text-center shadow-lg">
            ...
            <p className="text-gray-800 mb-1">Lun - Vie: 10:00 - 23:00</p>
            <p className="text-gray-800 mb-1">Sábados: 10:00 - 01:00</p>
            <p className="text-gray-800">Domingos: 12:00 - 22:00</p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 border-2 border-taco-green text-center shadow-lg">
            ...
            <p className="text-gray-800 mb-2">📱 55-1234-5678</p>
